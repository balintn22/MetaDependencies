...
namespace AssembliesByRepo.Logic.Space
{
    ...
    public class OldStyleCsProj
    {
        ...
        private static AssInfo.AssTypes ResolveOutputType(string outputType)
        {
            switch (outputType)
            {
                case "Exe": return AssInfo.AssTypes.Exe;
                case "Dll": return AssInfo.AssTypes.Dll;
